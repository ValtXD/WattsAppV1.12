...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for dados_estado in DADOS_ESTADOS:
            ...
            self.stdout.write(f"Tarifa {'criada' if created else 'atualizada'}: {tarifa.estado.nome} - R$ {tarifa.valor_kwh}/kWh")
        ...
        for dados_bandeira in DADOS_BANDEIRAS:
            ...
            self.stdout.write(f"Bandeira {'criada' if created else 'atualizada'}: {bandeira.get_cor_display()} - R$ {bandeira.valor_adicional}/kWh")
        ...
        for dados_tarifa in DADOS_TARIFA_SOCIAL:
            ...
            self.stdout.write(f"Tarifa Social {'criada' if created else 'atualizada'}: {tarifa_social.faixa_consumo} - {tarifa_social.desconto_percentual}%")
